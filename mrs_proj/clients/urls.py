...
from .views import ClientListView, ClientDetailView, ClientStatsView, client_noted, client_data, client_data_update, ClientGraphDataView
...
urlpatterns = [
    ...
    path('client-graph-data/<str:id>/', ClientGraphDataView.as_view(), name='client_graph_data'),
