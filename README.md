...
После принятия и мерджа PR, в которых вносились изменения в model, требуется
миграция. 
...
Проект переведен на python 12 версии. Подойдет версия начиная с 3.12.1
...
Будет информация, по покрытию (по файлам). tox создаст новое
виртуальное окружение в своей папке. Зависимости она подтянет сама.
